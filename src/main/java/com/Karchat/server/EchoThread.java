            ...
            while (flag) {
                ...
                switch (str) {
                    ...
                    case "addState":
                        ...
                        int t = addFriendMapper4.updateAddState(addStateName, username);
                        if (t == 1) {
                            out.println("true");
                        }
                    ...
                    case "deleteAddFriend":
                        ...
                        AddFriendMapper addFriendMapper5 = context.getBean(AddFriendMapper.class);

                        addFriendMapper5.deleteFriendName(deleteAddFriendName, username);
                        out.println("true");
                    ...
                    case "getFriendIcon":
                        ...
                        break;
                    case "getUserState":
                        AddFriendMapper addFriendMapper6 = context.getBean(AddFriendMapper.class);
                        ...
                        for (int r = 0; r < friends.length; r++) {
                            ...
                            User user2 = addFriendMapper6.getUserState(friendsName);
...
//
                    ...
                    case "getChatHistory":  //获取聊天历史内容
                        //先查聊天表名
                        final String[] chatLocation2 = new String[1];  //聊天表的位置
                        String me = buf.readLine();  //我的姓名
                        String friend = buf.readLine();  //好友的姓名
                        ChatMapper chatMapper1 = context.getBean(ChatMapper.class);
                        if (me.matches("^[0-9]*$")) {
                            chatLocation2[0] = chatMapper1.getChatLocation("_" + me, friend).getChatLocation();
                        } else {
                            chatLocation2[0] = chatMapper1.getChatLocation(me, friend).getChatLocation();
                        }

                        //获取聊天表中的全部内容
                        try {
                            Message[] chatHistory = chatMapper1.getChatHistory(chatLocation2[0]);//获取全部聊天内容
                            //发送给客户端
                            ...
                            log.info("聊天表" + chatLocation2[0] + "不存在");
                        }
