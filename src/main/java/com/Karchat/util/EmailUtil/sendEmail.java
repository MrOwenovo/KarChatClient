package com.Karchat.util.EmailUtil;
...
public class sendEmail {
    ...
    private final String myEmailPassword = "gqhcxeegxestjiih";
    ...
    public String Send() throws Exception {
        ...
        //直接传入内容
        String verifyMessage = VerifyUtil.getRandomString(6); //获取随机验证码
        info = "您的验证码是" + verifyMessage + ",感谢您注册KarGoBang并支持我们！";
    ...
    public  MimeMessage createMessage(Session session, String sendMail, String receiveMail,String info) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "KarGoBang", "UTF-8"));
        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "注册者", "UTF-8"));
        // 4. Subject: 邮件主题（标题有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改标题）
        message.setSubject("KarGoBang", "UTF-8");
